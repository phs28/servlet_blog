...
<div class="container">
	...
	<c:forEach items="${boardlist }"  var="var">
		<div class="card col-md-12 m-2">
			<div class="card-body">
				<h4 class="card-title">${var.title }</h4>
				<a href="/blog/board?cmd=detail&id=${var.id }" class="btn btn-primary">상세보기</a>
			</div>
		</div>
	</c:forEach>
	...
	<c:choose>
		<c:when test="${listPage == param.page }">
